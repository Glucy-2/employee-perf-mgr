...
class Window(QDialog, ui_manage.Ui_Form):
    def __init__(self):
        super().__init__()
        ...
        # self.quarter1_perf_spinbox = self.ui.quarter1_perf_spinbox # 第一季度业绩编辑框
        # self.quarter2_perf_spinbox = self.ui.quarter2_perf_spinbox # 第二季度业绩编辑框
        # self.quarter3_perf_spinbox = self.ui.quarter3_perf_spinbox # 第三季度业绩编辑框
        # self.quarter4_perf_spinbox = self.ui.quarter4_perf_spinbox # 第四季度业绩编辑框
